...
`.trim();
  ...
  const core = {
    ...
    createDefaultContentSettings, normalizeContentSettings, normalizeGenderEntries, formatGenderEntry, genderEntriesEditor, preUpgradeEffects, replaceUpgradedEffects, buildOwnedSkillsSection, buildNobleSection, formatEffectSuffix, insertEffectNotation, toggleEffectNotation, effectTokens, renderContentSettingsEditors,
