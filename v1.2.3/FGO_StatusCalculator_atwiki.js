...
`.trim();
  ...
  const core = { VERSION, SERVANT_TEMPLATE, calculate, replaceSource, parseTraitsFromSource, parseSelectedTraitsFromSource, buildColumnStyle, buildHeaderLine, buildStatusRow, buildNaLine, buildParameterRow };
