...
assert.match(renderedEditors.bond, /data-skill-icon-picker-for="bond\.icon"/);
assert.match(renderedEditors.bond, /type="hidden" data-model-path="bond\.icon" value="宝具威力アップ\.png"/);
assert.doesNotMatch(renderedEditors.bond, /効果アイコンファイル名/);
