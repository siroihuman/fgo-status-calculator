...
`.trim();
  ...
  const core = {
    ...
    createDefaultContentSettings, normalizeContentSettings, preUpgradeEffects, buildOwnedSkillsSection, buildNobleSection, formatEffectSuffix, insertEffectNotation, toggleEffectNotation, effectTokens, renderContentSettingsEditors,
