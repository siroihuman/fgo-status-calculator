...
`.trim();
  ...
  const core = {
    ...
    createDefaultContentSettings, normalizeContentSettings, buildOwnedSkillsSection, buildNobleSection, formatEffectSuffix,
  ...
  function renderApp(root) {
    ...
    root.innerHTML = `<form class="fsc-shell" autocomplete="on">
      ...
      <section class="fsc-section"><h3>宝具設定</h3>
        <p class="fsc-help">宝具は1枠です。通常の宝具種類・Hit数と、強化後、第二／第三再臨以降の名称・効果・宝具種類・Hit数の差分をまとめて設定します。</p>
